...
def compute(s: str) -> int:
    ...
    seed_ranges = []
    for start, quantity in itertools.batched(d_maps["seeds"], n=2):
        seed_ranges.append(range(start, start + quantity))
    ...
    for seed_number in all_seeds(seed_ranges):
        current_min = min(seed_location(seed_number, d_maps), current_min)
